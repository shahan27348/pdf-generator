 ...
 return (
   <div className="fixed w-full z-50 flex justify-between items-center py-2 px-4 border-b border-pink-200/20 bg-white/80 backdrop-blur-sm h-16">
     ...
     <div className="hidden md:flex items-center space-x-6">
       <Link href="/your-summary" className="text-gray-600 hover:text-gray-800 transition-colors font-medium">
         Your Summary
       </Link>
     </div>
     
     <div className="flex items-center gap-x-3">
       <Link href="/upload" className="text-red-500 hover:text-red-600 transition-colors">
         Upload PDF
       </Link>
       <ModeToggle />
       <UserButton />

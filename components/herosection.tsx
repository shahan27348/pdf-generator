    ...
    <main className="px-6 py-12 pt-32">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl text-gray-600 mb-12 max-w-2xl mx-auto leading-relaxed">
          Get a beautiful summary reel of the document in seconds. Our
          AI-powered tool transforms lengthy PDFs into digestible insights.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600">
              Process documents in seconds, not minutes. Our AI works at
              incredible speed.
            </p>
          </div>
          ...
          <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600">
              Advanced AI identifies key points and creates coherent summaries.
            </p>
          </div>
          ...
          <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600">
              Reduce reading time by 90% while retaining all important
              information.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white/40 backdrop-blur-sm rounded-2xl p-8 mb-16">
          ...
          <p className="text-gray-700 text-lg mb-4">
            "This tool has revolutionized how I handle research papers. What
        ...
        <div className="bg-gradient-to-r from-pink-500 to-purple-600 rounded-3xl p-8 text-white">
          ...
          <p className="text-pink-100 mb-6 text-lg">
            Join thousands of professionals who save hours every week with our
